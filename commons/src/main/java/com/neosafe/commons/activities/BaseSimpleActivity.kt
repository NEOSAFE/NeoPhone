package com.neosafe.commons.activities
...
import com.neosafe.commons.asynctasks.CopyMoveTask
import com.neosafe.commons.dialogs.ConfirmationDialog
import com.neosafe.commons.dialogs.ExportSettingsDialog
import com.neosafe.commons.dialogs.FileConflictDialog
import com.neosafe.commons.dialogs.WritePermissionDialog
import com.neosafe.commons.extensions.*
import com.neosafe.commons.helpers.*
import com.neosafe.commons.interfaces.CopyMoveListener
import com.neosafe.commons.models.FAQItem
import com.neosafe.commons.models.FileDirItem
import java.io.File
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        return if (!packageName.startsWith("com.neosafe")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        ...
        if (defaultFilename.isEmpty()) {
            val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.neosafe.")
