...
import com.neosafe.commons.helpers.MyContentProvider.Companion.COL_ACCENT_COLOR
import com.neosafe.commons.helpers.MyContentProvider.Companion.COL_APP_ICON_COLOR
import com.neosafe.commons.helpers.MyContentProvider.Companion.COL_BACKGROUND_COLOR
import com.neosafe.commons.helpers.MyContentProvider.Companion.COL_LAST_UPDATED_TS
import com.neosafe.commons.helpers.MyContentProvider.Companion.COL_NAVIGATION_BAR_COLOR
import com.neosafe.commons.helpers.MyContentProvider.Companion.COL_PRIMARY_COLOR
import com.neosafe.commons.helpers.MyContentProvider.Companion.COL_TEXT_COLOR
import com.neosafe.commons.models.AlarmSound
import com.neosafe.commons.models.BlockedNumber
import com.neosafe.commons.models.SharedTheme
import com.neosafe.commons.views.*
import java.io.File
...
fun Context.isAProApp() = packageName.startsWith("com.neosafe.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.neosafe."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.neosafe.contacts") && !packageName.startsWith("com.neosafe.neophone")) {
        true
    } else if ((packageName.startsWith("com.neosafe.contacts") || packageName.startsWith("com.neosafe.neophone")) && isQPlus()) {
