package com.neosafe.commons.helpers
...
import com.neosafe.commons.extensions.getIntValue
import com.neosafe.commons.extensions.getStringValue
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.neosafe.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.neosafe.neophone" && packageName != "com.simplemobiletools.smsmessenger" && packageName != "com.simplemobiletools.calendar.pro") {
                return contacts
            }
