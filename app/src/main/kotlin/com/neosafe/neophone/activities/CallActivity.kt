...
import com.neosafe.neophone.extensions.addCharacter
import com.neosafe.neophone.extensions.audioManager
import com.neosafe.neophone.extensions.config
import com.neosafe.neophone.extensions.getHandleToUse
...
import com.neosafe.neophone.receivers.CallActionReceiver
...
class CallActivity : SimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Register receiver for speaker on requests from eSafeMe PRO
        val br: BroadcastReceiver = SpeakerOnRequestReceiver()
        registerReceiver(br, IntentFilter("com.neosafe.esafemepro.SPEAKER_ON"))
    }
    ...
    private fun initProximitySensor() {
        if (proximityWakeLock == null || proximityWakeLock?.isHeld == false) {
            ...
            proximityWakeLock = powerManager.newWakeLock(PowerManager.PROXIMITY_SCREEN_OFF_WAKE_LOCK, "com.neosafe.neophone.pro:wake_lock")
    ...
    private class SpeakerOnRequestReceiver : BroadcastReceiver() {

        override fun onReceive(context: Context, intent: Intent) {
            context.audioManager.isSpeakerphoneOn = true
            val newRoute = CallAudioState.ROUTE_SPEAKER
            CallManager.inCallService?.setAudioRoute(newRoute)
        }
    }
}
